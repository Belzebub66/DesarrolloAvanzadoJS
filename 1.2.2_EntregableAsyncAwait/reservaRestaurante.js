...
hacerReserva("John Doe", 3);  // Intenta hacer una reserva para 3 personas

// Llamada de prueba fallida
hacerReserva("Jane Smith", 10);  // Intenta hacer una reserva para 10 personas